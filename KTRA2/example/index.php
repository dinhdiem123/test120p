    ...
    public function __construct() {
        ...
        if (isset($_SESSION['server'], $_SESSION['username'], $_SESSION['password'], $_SESSION['database'])) {
            ...
            public function getCourses() {
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="'. strtolower($row['Img']) . '" class="card-img-top" alt="' . $row['Title'] . '">
                                <div class="card-body">
            ...
            public function addCourse($tittle, $description, $ImgUrl) {
                ...
                $sql = "INSERT INTO course Title, Des, Img) VALUES (?, ?, ?)";
                $stmt = $this->conn->prepare($sql);
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
            ...
            if (empty($courses)) {
                ...
                foreach ($courses as $course) {
                    ...
                    $content .= "Description: " . $course['Des'] . "\n";
                    $content .= "ImageUrl: " . $course['Img'] . "\n";
                    $content .= "---------------------\n";
                }
